...
- ~~Métricas reais do dashboard...~~ Resolvido em 2026-07-10 — domínio de Pedidos/Relatórios já existe no backend (Fases 5-6), Dashboard consome `GET /reports/indicators`/`GET /reports/charts` com dado real.
...
8. ⏳ Primeira listagem de domínio em ag-Grid — candidata a próximo passo real. Provável próximo: tela de Pedidos (destrava as 3 ações rápidas do Dashboard que hoje estão "Em breve").
