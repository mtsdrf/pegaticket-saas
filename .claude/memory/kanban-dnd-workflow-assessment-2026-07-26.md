...
- Cobertura inicial pronta em [api/tests/Feature/Workflow/WorkflowTransitionLogTest.php](/home/mtsdrf/workspace/pegaticket-saas/api/tests/Feature/Workflow/WorkflowTransitionLogTest.php), validando aprovação de pedido e cancelamento de item de comanda com motivo.
- Em 26 de julho de 2026 a etapa 2 também foi iniciada e concluída para os dois primeiros alvos definidos.
- A central de operação em [web/src/pages/Order/OrderListPage.tsx](/home/mtsdrf/workspace/pegaticket-saas/web/src/pages/Order/OrderListPage.tsx) agora usa colunas arrastáveis e zonas de ação terminal, preservando botões rápidos e filtros existentes.
...
- Em 26 de julho de 2026 a expansão para `Pedidos da loja` também foi concluída em [web/src/pages/Order/StorefrontOrderManagementPage.tsx](/home/mtsdrf/workspace/pegaticket-saas/web/src/pages/Order/StorefrontOrderManagementPage.tsx), mantendo o modal de gestão detalhada e adicionando arraste operacional por etapas.
...
- O frontend ganhou o diálogo compartilhado [web/src/components/workflow/WorkflowTimelineDialog.tsx](/home/mtsdrf/workspace/pegaticket-saas/web/src/components/workflow/WorkflowTimelineDialog.tsx), reutilizado na central operacional, nos pedidos da loja e no KDS.
