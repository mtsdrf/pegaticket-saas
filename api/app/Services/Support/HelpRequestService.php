...
class HelpRequestService
{
    ...
    public function __construct(
        private HelpRequestRepositoryInterface $repository,
    ...
    public function create(int $tenantId, CreateHelpRequestDTO $dto, ?UploadedFile $attachment): HelpRequest
    {
        return DB::transaction(function () use ($tenantId, $dto, $attachment) {
            ...
            if ($attachment) {
                $attachmentPath = $attachment->store('help-requests', 'public');
