 ...
 * operação inteira. Ver App\Services\Order\OrderInstallmentService::reallocate()
 * e .claude/memory/architecture-decisions.md.
 */
class ReallocateOrderInstallmentsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // endpoints individuais, StoreOrderInstallmentRequest).
