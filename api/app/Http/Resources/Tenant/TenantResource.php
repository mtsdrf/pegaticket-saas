...
class TenantResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'has_fiscal_nfce_csc_code' => filled($this->fiscal_nfce_csc_code),
            'has_fiscal_provider_api_token' => filled($this->fiscal_provider_api_token),
            'has_fiscal_certificate_a1' => filled($this->fiscal_certificate_a1_data),
            'fiscal_certificate_a1_name' => $this->fiscal_certificate_a1_name,
            'fiscal_certificate_a1_updated_at' => optional($this->fiscal_certificate_a1_updated_at)?->toDateTimeString(),
