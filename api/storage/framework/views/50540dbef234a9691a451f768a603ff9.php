...
<head>
    <meta charset="utf-8">
    <title>Ingressos <?php echo e($sale->codigo); ?></title>
    <style>
        body {
...
<body>
    <div class="page-shell">
        <div class="brand-header">
            <table class="brand-table" role="presentation">
                <tr>
                    <td>
                        <?php if($logoDataUri): ?>
                            <img src="<?php echo e($logoDataUri); ?>" alt="PegaTicket" class="brand-logo">
                        <?php endif; ?>
                    </td>
        ...
        <div class="document-card">
            <h1 class="document-title">Ingressos da venda #<?php echo e($sale->codigo); ?></h1>
            ...
            <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="ticket-card">
                    <div class="ticket-header">
                        <p class="event-name"><?php echo e($ticket->ticketType?->event?->name ?? 'Evento'); ?></p>
                        <p class="event-meta">
                            <?php echo e($ticket->ticketType?->name ?? 'Ingresso'); ?>

                            <?php if($ticket->ticketType?->session?->name): ?>
                                · <?php echo e($ticket->ticketType->session->name); ?>
                    ...
                    <table class="grid" role="presentation">
                        <tr>
                            <td>
                                ...
                                <div class="field-value"><?php echo e($ticket->attendee_name ?: ($sale->finalCustomer?->name ?? 'Não informado')); ?></div>
                            </td>
                            <td>
                                <div class="field-label">Documento</div>
                                <div class="field-value"><?php echo e($ticket->attendee_document ?: 'Não informado'); ?></div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <div class="field-value">
                                    <?php if($ticket->seat?->label): ?>
                                        <?php echo e($ticket->seat->label); ?><?php echo e($ticket->seat->sector_name ? ' — ' . $ticket->seat->sector_name : ''); ?>
                            ...
                            <td>
                                ...
                                <div class="field-value"><?php echo e(ucfirst((string) $ticket->status)); ?></div>
                            </td>
                        </tr>
                    </table>
...
<?php /**PATH /home/mtsdrf/workspace/pegaticket-saas/api/resources/views/tickets/pdf.blade.php ENDPATH**/ ?>