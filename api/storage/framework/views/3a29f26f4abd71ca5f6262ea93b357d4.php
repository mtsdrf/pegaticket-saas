...
<body style="margin:0;padding:0;background-color:#eef4f7;font-family:Arial,Helvetica,sans-serif;color:#143b33;">
    <?php if($resolvedPreheader !== ''): ?>
        <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;">
            <?php echo e($resolvedPreheader); ?>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 auto;">
                                            <tr>
                                                <td style="vertical-align:middle;">
                                                    <img src="<?php echo e($logoUrl); ?>" alt="<?php echo e($appName); ?>" width="164" style="display:block;width:164px;max-width:100%;height:auto;border:0;">
                                                </td>
                    ...
                    <tr>
                        <td>
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background-color:#ffffff;border:1px solid #d5e4ea;border-top:0;border-radius:0 0 24px 24px;box-shadow:0 18px 48px rgba(8,207,167,0.16);">
                                ...
                                <tr>
                                    <td style="padding:<?php echo e($resolvedHeadline !== '' || $resolvedSubheadline !== '' ? '16px 32px 20px 32px' : '32px'); ?>;font-size:15px;line-height:1.7;color:#143b33;">
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="border-top:1px solid #dfe9ed;">
                                            <tr>
                                                <td style="padding-top:18px;font-size:12px;line-height:1.6;color:#78908c;">
                                                    <?php echo e($resolvedFooterNote !== '' ? $resolvedFooterNote : 'Este e-mail foi enviado automaticamente pelo PegaTicket. Se precisar, acesse a plataforma para continuar o atendimento.'); ?>

                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-top:6px;font-size:12px;line-height:1.6;color:#9aaeb2;">
                                                    © <?php echo e(now()->year); ?> <?php echo e($appName); ?>. Todos os direitos reservados.
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
...
<?php /**PATH /home/mtsdrf/workspace/pegaticket-saas/api/resources/views/emails/layouts/base.blade.php ENDPATH**/ ?>