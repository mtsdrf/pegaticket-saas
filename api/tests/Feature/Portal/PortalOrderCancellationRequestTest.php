 ...
 * cancelamento"): POST /portal/orders/{uuid}/request-cancellation. Só
 * pedido origin=storefront, só enquanto não saiu para entrega/entregue.
 */
class PortalOrderCancellationRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function customer_requests_cancellation_successfully(): void
    {
        ...
        $response = $this->withHeader('Authorization', 'Bearer ' . $token)
            ->postJson('/api/v1/portal/orders/' . $order->uuid . '/request-cancellation', [
