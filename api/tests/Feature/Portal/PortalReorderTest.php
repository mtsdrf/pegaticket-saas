 ...
 * GET /portal/orders/{uuid}/items, preço/disponibilidade ATUAIS do produto,
...
class PortalReorderTest extends TestCase
{
    ...
    public function returns_404_for_nonexistent_order_uuid(): void
    {
        ...
        $this->withHeader('Authorization', 'Bearer ' . $token)
            ->getJson('/api/v1/portal/orders/' . Str::uuid() . '/items')
            ->assertStatus(404);
    }
    ...
    {
        $this->getJson('/api/v1/portal/orders/' . Str::uuid() . '/items')->assertStatus(401);
    }
}
