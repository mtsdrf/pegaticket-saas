...
class HelpRequestTest extends TestCase
{
    ...
    {
        $response = $this->auth()->postJson('/api/v1/support/help-requests', [
    ...
    {
        $this->auth()->postJson('/api/v1/support/help-requests', [
            'subject' => 'Meu chamado',
            'description' => 'Descrição do chamado.',
        ]);

        $response = $this->auth()->getJson('/api/v1/support/help-requests');
