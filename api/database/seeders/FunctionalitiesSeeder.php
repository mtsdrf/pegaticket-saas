...
class FunctionalitiesSeeder extends Seeder
{
    public function run(): void
    {
        $items = [
            ...
            ['name' => 'Integrações', 'slug' => 'api-access', 'description' => 'Integrações externas, chaves de API, webhooks e canais conectados', 'is_active' => true],
            ['name' => 'Rotas', 'slug' => 'routes', 'description' => 'Planejamento e acompanhamento de rotas operacionais', 'is_active' => true],
            ['name' => 'Acesso do Contador', 'slug' => 'accounting-access', 'description' => 'Vínculo e aprovação de acesso do escritório contábil à empresa', 'is_active' => true],
            ['name' => 'Regras Fiscais', 'slug' => 'tax-rules', 'description' => 'Perfis fiscais, regras tributárias e prontidão fiscal da empresa', 'is_active' => true],
