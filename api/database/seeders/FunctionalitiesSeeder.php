...
class FunctionalitiesSeeder extends Seeder
{
    public function run(): void
    {
        $items = [
            ...
            ['name' => 'Cotas por Canal', 'slug' => 'ticket_type_channel_quotas', 'description' => 'Gestão de cotas de inventário por canal de venda (loja própria, staff/bilheteria, afiliado)', 'is_active' => true],
            ...
            ['name' => 'Vendas', 'slug' => 'sales', 'description' => 'Gestão de vendas', 'is_active' => true],
            ['name' => 'Estornos', 'slug' => 'sale_refunds', 'description' => 'Registro de estorno externo de vendas (spec 5.14)', 'is_active' => true],
            ['name' => 'Caixa', 'slug' => 'cash_sessions', 'description' => 'Abertura e fechamento de caixa da bilheteria presencial', 'is_active' => true],
            ['name' => 'Ingressos', 'slug' => 'tickets', 'description' => 'Ingressos digitais emitidos e controle de acesso/check-in', 'is_active' => true],
            ['name' => 'Compradores', 'slug' => 'customers', 'description' => 'Busca de compradores (FinalCustomer) pelo staff, usada na venda manual', 'is_active' => true],
