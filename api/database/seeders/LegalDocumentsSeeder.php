        ...
        $documents = [
            [
                ...
                'content' => implode("\n\n", [
                    ...
                    '1. Objeto',
                    'A PegaTicket disponibiliza uma plataforma de gestão empresarial com recursos como cadastro de clientes, produtos, vendas, usuários, permissões, relatórios, integrações e demais módulos contratados pela empresa usuária.',
                    '2. Partes',
                    ...
                    'A empresa contratante é responsável pela veracidade, qualidade, base legal e legitimidade dos dados cadastrados no sistema, incluindo dados de clientes, usuários, produtos, vendas, endereços, documentos e integrações externas.',
            ...
            [
                ...
                'content' => implode("\n\n", [
                    ...
                    'A PegaTicket registra internamente solicitações relacionadas à privacidade e coopera com a empresa contratante quando houver venda que envolva dados tratados dentro do ambiente contratado. Dependendo do tipo de solicitação, pode ser necessário validar identidade, legitimidade da venda, escopo dos dados e obrigações de retenção aplicáveis.',
