    ...
    public function run(): void
    {
        $documents = [
            [
                ...
                'version' => '2026-07-26',
                'content' => implode("\n\n", [
                    'Termos de Uso da Plataforma Maskats',
                    'Vigência da versão: 26/07/2026.',
                    '1. Objeto',
                    'A Maskats disponibiliza uma plataforma de gestão empresarial com recursos como cadastro de clientes, produtos, pedidos, usuários, permissões, relatórios, integrações e demais módulos contratados pela empresa usuária.',
                    '2. Partes',
                    'Neste documento, "Maskats" é a fornecedora da plataforma. "Empresa contratante" é a pessoa jurídica ou o empresário responsável pela assinatura e pelo uso do ambiente cadastrado. "Usuários da empresa" são as pessoas autorizadas pela empresa contratante a operar o sistema.',
                    ...
                    'A Maskats buscará manter a plataforma disponível de forma contínua, observado que poderão ocorrer indisponibilidades programadas, manutenção corretiva, falhas de terceiros, eventos de infraestrutura, limitações de conectividade e situações fora do controle razoável da fornecedora.',
                    '10. Suporte e evolução do produto',
                    'O escopo de suporte, canais de atendimento, SLA, onboarding assistido, customizações e novas funcionalidades dependem do plano contratado, da proposta comercial aplicável e da política operacional vigente da Maskats.',
                    '11. Propriedade intelectual',
                    'O software, sua interface, marca, documentação, código, fluxos, materiais e demais ativos intelectuais permanecem de titularidade da Maskats ou de seus licenciadores. A contratação não transfere propriedade do software, apenas direito de uso nos limites contratados.',
                    '12. Segurança da informação',
                    'A Maskats adota controles técnicos e organizacionais compatíveis com a natureza da plataforma, mas nenhum ambiente conectado à internet é absolutamente invulnerável. A empresa contratante também deve cumprir sua parte com senhas fortes, revisão de acessos, equipamentos protegidos e uso responsável.',
                    ...
                    'A Maskats poderá suspender total ou parcialmente o acesso da empresa em situações como inadimplência, risco de fraude, uso indevido, violação destes termos, determinação legal ou necessidade de contenção de incidente. Cancelamentos, arrependimento, renovação e recontratação seguem o fluxo disponível no sistema e as condições comerciais aplicáveis.',
                    '15. Limitação de responsabilidade',
                    'A Maskats não se responsabiliza por decisões de negócio tomadas pela empresa usuária, por cadastros incorretos realizados pelos próprios usuários, por falhas de serviços de terceiros integrados ou por perdas decorrentes de uso em desacordo com a documentação, políticas e boas práticas informadas pela plataforma.',
                    ...
                    '17. Contato',
                    'Demandas contratuais, dúvidas operacionais e solicitações relacionadas a estes termos devem ser encaminhadas pelos canais oficiais de atendimento informados pela Maskats.',
                ]),
            ],
            [
                'type' => 'privacy',
                'version' => '2026-07-26',
                'content' => implode("\n\n", [
                    'Política de Privacidade da Plataforma Maskats',
                    'Vigência da versão: 26/07/2026.',
                    '1. Objetivo desta política',
                    'Esta política descreve, em linguagem operacional, como a Maskats trata dados pessoais no contexto da plataforma, inclusive no cadastro da empresa, autenticação, administração de usuários, operação dos módulos contratados, suporte e integrações habilitadas.',
                    '2. Papéis no tratamento de dados',
                    'A Maskats atua, em regra, como controladora dos dados do relacionamento comercial, suporte, cobrança, segurança da conta e administração da própria plataforma. Em relação aos dados pessoais inseridos pela empresa contratante no uso do sistema, a Maskats atua predominantemente como operadora, tratando os dados conforme as instruções legítimas da empresa usuária e as necessidades técnicas do serviço.',
                    ...
                    'A Maskats poderá tratar dados pessoais com fundamento, conforme o caso concreto, na execução de contrato, procedimentos preliminares relacionados à contratação, cumprimento de obrigação legal ou regulatória, exercício regular de direitos, legítimo interesse e, quando necessário, consentimento.',
                    ...
                    'Alguns fornecedores utilizados pela plataforma podem processar dados em ambientes externos ou distribuídos. Sempre que aplicável, a Maskats buscará adotar salvaguardas contratuais e operacionais compatíveis com o nível de risco e com a natureza do serviço contratado.',
                    ...
                    'Dúvidas, comunicações e solicitações relacionadas à privacidade e proteção de dados devem ser encaminhadas pelos canais oficiais da Maskats informados no sistema ou na relação comercial vigente.',
                ]),
            ],
        ];
