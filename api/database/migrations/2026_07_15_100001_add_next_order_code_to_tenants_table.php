...
return new class extends Migration {
    public function up(): void
    {
        Schema::table('tenants', function (Blueprint $table) {
            // Guarda o ÚLTIMO orders.codigo emitido pelo tenant (não o
            ...
            // também o comando orders:backfill-codigo (mesma convenção).
            $table->unsignedInteger('next_order_code')->default(999);
        });
    }
    ...
    {
        Schema::table('tenants', function (Blueprint $table) {
            $table->dropColumn('next_order_code');
        });
    }
};
