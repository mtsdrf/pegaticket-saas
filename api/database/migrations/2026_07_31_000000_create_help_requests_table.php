 ...
 * HelpRequestService::buildDiagnostics). `created_by` (de BaseModel) já
 * identifica o autor, sem coluna extra de user.
 *
 * Entidade renomeada de SupportTicket para HelpRequest (2026-07-31):
 * "Ticket" passou a ser reservado para o domínio central do produto
 * (ingresso de evento), sem ambiguidade com o módulo de suporte.
 */
return new class extends Migration {
    public function up(): void
    {
        Schema::create('help_requests', function (Blueprint $table) {
            ...
            $table->index(['tenant_id', 'created_at'], 'idx_help_requests_tenant_created');
        });
    }
