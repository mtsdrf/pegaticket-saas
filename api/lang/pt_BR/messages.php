...
return [
    ...
    */
    ...
    'payment' => [
        ...
        'payer_tax_id_required' => 'Informe o CPF ou CNPJ do pagador para continuar com a cobrança.',
        'card_data_required' => 'Não foi possível ler os dados criptografados do cartão. Atualize a página e tente novamente.',
        'card_holder_name_required' => 'Informe o nome do titular do cartão.',
        'card_holder_tax_id_required' => 'Informe o CPF ou CNPJ do titular do cartão.',
        'installments_required' => 'Informe a quantidade de parcelas do cartão de crédito.',
        'debit_authentication_required' => 'A autenticação 3DS do cartão de débito é obrigatória para concluir a cobrança.',
        'method_not_supported' => 'Este meio de pagamento ainda não está disponível neste ambiente.',
    ...
    */
    'sale' => [
        ...
        'fiscal_document_shown' => 'Documento fiscal da venda exibido com sucesso.',
        'fiscal_document_not_found' => 'Esta venda ainda não possui um documento fiscal preparado.',
        'fiscal_document_prepared' => 'Documento fiscal interno da venda preparado com sucesso.',
        ...
        'fiscal_document_cancel_unavailable' => 'Não existe um documento fiscal preparado ativo para cancelar nesta venda.',
        'fiscal_document_submit_unavailable' => 'Não existe um rascunho fiscal preparado pronto para envio nesta venda.',
        'fiscal_document_sync_unavailable' => 'Não existe um documento fiscal em processamento disponível para consulta nesta venda.',
        ...
        'fiscal_document_invalidated_after_order_update' => 'Documento fiscal preparado cancelado porque a venda foi alterada.',
        'fiscal_document_invalidated_after_order_cancel' => 'Documento fiscal preparado cancelado porque a venda foi cancelada.',
        ...
        'fiscal_prepare_blocked' => 'Existem pendências fiscais na venda. Corrija os itens apontados antes de preparar o documento fiscal.',
        'fiscal_prepare_authorized_exists' => 'Esta venda já possui um documento fiscal autorizado. Crie uma operação fiscal complementar em vez de preparar um novo documento.',
        'fiscal_prepare_submitted_exists' => 'Esta venda já possui um documento fiscal enviado ao provider. Aguarde o retorno operacional ou cancele o fluxo atual antes de preparar outro.',
        ...
        'fiscal_submit_authorized_exists' => 'Esta venda já possui um documento fiscal autorizado. Não é possível reenviar um novo documento pelo fluxo padrão.',
        ...
        'installments_count_required' => 'A quantidade de parcelas é obrigatória para venda parcelada.',
        'already_cancelled' => 'Esta venda já foi cancelada.',
        'already_completed' => 'Esta venda já foi marcada como concluída.',
        'not_completed' => 'Esta venda ainda não foi marcada como concluída.',
        'already_paid' => 'Esta venda já foi marcada como paga.',
        'not_paid' => 'Esta venda ainda não foi marcada como paga.',
        'not_installment' => 'Esta venda não é parcelada.',
        'installment_already_paid' => 'Esta parcela já foi paga.',
        'installment_not_paid' => 'Esta parcela ainda não foi paga.',
        'cannot_cancel_paid' => 'Não é possível cancelar uma venda com pagamento já registrado. É necessário um estorno manual.',
        'payment_charge_created' => 'Cobrança de pagamento gerada com sucesso.',
        'payment_checkout_config_loaded' => 'Configuração do checkout carregada com sucesso.',
        'payment_charge_already_active' => 'Esta venda já possui uma cobrança de pagamento em aberto.',
        'missing_reservation' => 'Reserva de estoque não encontrada para este item da venda.',
        ...
        'installment_number_duplicate' => 'Já existe uma parcela com este número para esta venda.',
        'installment_sum_mismatch' => 'A soma de todas as parcelas (:sum) precisa bater exatamente com o total da venda (:total). Diferença: :diff.',
        'installment_not_found_in_order' => 'Uma das parcelas referenciadas não pertence a esta venda ou não existe.',
        ...
        'refund_list' => 'Lista de estornos da venda.',
        'refund_partial_requires_tickets' => 'Estorno parcial exige selecionar ao menos um ingresso afetado.',
        'refund_ticket_not_found_in_order' => 'Um dos ingressos informados não pertence a esta venda, não existe ou já foi estornado.',
        'refund_no_eligible_tickets' => 'Não há ingressos elegíveis para estorno nesta venda.',
        'refund_amount_exceeds_paid' => 'O valor do estorno excede o valor disponível para estorno (:available).',
        'tracking_shown' => 'Acompanhamento da venda exibido com sucesso.',
        'items_updated' => 'Itens da venda atualizados com sucesso.',
        'item_not_found_in_order' => 'Um dos itens referenciados não pertence a esta venda ou não existe.',
        ...
        'not_pending_approval' => 'Esta venda não está aguardando aprovação.',
        'approved' => 'Venda aprovada com sucesso.',
        'rejected' => 'Venda recusada com sucesso.',
        'awaiting_approval' => 'Esta venda ainda está aguardando aprovação. Aprove-a antes de registrar o pagamento.',
        'order_rejected' => 'Esta venda foi recusada e não pode ser paga.',
        'prep_link_generated' => 'Link de preparo gerado com sucesso.',
        'prep_shown' => 'Preparo da venda exibido com sucesso.',
        'cancellation_request_not_storefront' => 'Somente compras feitas pela bilheteria online podem ter o cancelamento solicitado por este canal.',
        'cancellation_already_requested' => 'Já existe uma solicitação de cancelamento em aberto para esta venda.',
        'no_cancellation_requested' => 'Esta venda não possui uma solicitação de cancelamento em aberto.',
    ...
    */
    'storefront' => [
        ...
        'checkout_created' => 'Compra realizada com sucesso. Aguarde a confirmação da bilheteria.',
        ...
        'below_minimum_order' => 'Compra abaixo do valor mínimo. Faltam R$ :missing para atingir o mínimo.',
    ...
    'inventory_hold' => [
        ...
        'max_per_order_exceeded' => 'A quantidade solicitada ultrapassa o limite permitido por compra.',
    ...
    */
    'coupon' => [
        ...
        'below_minimum_order' => 'Este cupom exige um valor mínimo de compra de R$ :minimum.',
    ...
    */
    'report' => [
        ...
        'sales_list' => 'Lista do relatório de vendas.',
        'sales_summary' => 'Resumo do relatório de vendas.',
    ...
    */
    'push' => [
        ...
        'order_approved_title' => 'Compra aprovada',
        'order_approved_body' => 'Sua compra foi aprovada!',
        'order_rejected_title' => 'Compra recusada',
        'order_rejected_body' => 'Sua compra foi recusada.',
        'order_completed_title' => 'Compra concluída',
        'order_completed_body' => 'Sua compra foi concluída!',
    ],
    ...
    */
    'portal' => [
        ...
        'otp_delivery_unavailable' => 'Não foi possível enviar o código de acesso por e-mail agora. Tente novamente em instantes ou revise a configuração de SMTP.',
        'link_confirmed' => 'Loja vinculada com sucesso ao seu histórico.',
        'sales_shown' => 'Vendas do cliente.',
        'me_shown' => 'Perfil do cliente.',
        'sale_items_shown' => 'Itens da venda para nova venda.',
