...
const TRAINING_MODULES: TrainingModule[] = [
  ...
  {
    id: 'catalogo',
    name: 'Eventos e catálogo',
    summary: 'Ensina a estruturar categorias, eventos, tipos de ingresso e adicionais do catálogo.',
    status: 'implemented',
    route: '/eventos',
    ...
    operations: [
      {
        title: 'Cadastrar evento operacional',
        purpose: 'Criar um evento pronto para venda de ingressos e publicação.',
        when: 'Durante implantação inicial ou expansão do catálogo.',
        actor: 'Cadastro ou comercial',
        route: '/eventos/novo',
        permissionLabel: 'events:create',
