...
import type { OrderReportFilters, OrderReportSummary } from '../../types/reportDetail'
import { CHANNEL_LABELS } from '../../types/report'
import { getApiErrorMessage } from '../../types/api'
import { formatCurrency, formatPercentage } from '../../utils/format'

export function OrderReportListPage() {
  ...
  const drillDownFilters = useMemo<OrderReportFilters>(
    () => ({
  ...
  const fetchPage = useCallback(
    async ({ page, perPage, sortBy, sortDir, filters: gridFilters }: ServerGridFetchParams): Promise<ServerGridFetchResult<Order>> => {
