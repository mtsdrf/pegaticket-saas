...
export interface TenantSettings {
  ...
  /** Quando ligado, `OrderService::create()` bloqueia (422 `INSUFFICIENT_STOCK`) pedido sem disponibilidade suficiente; hoje só tem efeito prático nas vendas do canal online. */
